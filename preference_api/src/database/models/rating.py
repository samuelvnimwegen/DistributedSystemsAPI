...
if TYPE_CHECKING:
    from src.database.models import RatingReview
...
class Rating(Base):
    ...
    review: Mapped[str]
    """The review text associated with the rating."""
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "movie_id", name="unique_rating"),
    )
    ...
    def __init__(
        ...
        assert isinstance(review, str), "Review must be a string."
